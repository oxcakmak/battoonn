...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("ticket-dm-disable")
    .setDescription(
      "It does not allow the transcript copy to be sent via DM when the ticket is closed."
    ),
  async execute(interaction) {
    ...
    ticketConfigsQuery.sendDm = false;
    ...
    return await interaction.reply({
      content: "Sending transcript via private message is not allowed",
    });
  },
};
